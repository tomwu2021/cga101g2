 ...
 <div class="d-flex align-items-stretch">
      <div id="sidebar" class="sidebar py-3" style="background:#343a40">
        ...
        <ul class="sidebar-menu list-unstyled">
          <li class="sidebar-list-item"><a href="<%=request.getContextPath()%>/back/emp/empSelect.jsp" class="sidebar-link text-white" onmouseover="hover_color(this);"  onmouseout="default_color(this);"><i class="o-home-1 mr-3 text-white"></i><span>後台主頁</span></a></li>
          <li class="sidebar-list-item"><a href="<%=request.getContextPath()%>/back/emp/empSelect.jsp" class="sidebar-link text-white" onmouseover="hover_color(this);"  onmouseout="default_color(this);"><i class="o-user-details-1 mr-3 text-white"></i><span>會員管理</span></a>
          </li>
