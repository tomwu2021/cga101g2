                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="slider_content slider_c_three">
                                ...
                                <%count++;%>
                                <a class="button"
                                   href="<%=request.getContextPath()%>/article?action=all_Display#<%=count%>">了解更多</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <figure class="single_banner">
                            <div class="banner_thumb">
                                <a href="<%=request.getContextPath()%>/${artiVO.content}"><img src='${artiVO.picVO.url}'
                                                                                               alt=""
...
<div class="testimonial_area testimonial_three color_two mb-95">
    <div class="container-fluid">
                        ...
                        <div class="col-lg-4">
                            <div class="single-testimonial">
                                <div class="testimonial_author mb-1">
                                    <a href="<%=request.getContextPath()%>/PersonPost?action=getOne_For_Display&memberId=${postVO.memberId}"
                                       style='line-height:36px;font-size:20px;'><img
                                            src='${postVO.pictureVO2.previewUrl}'
                                            style='display:inline-block;height:32px;width:32px;object-fit:cover;border-radius:50%;'>&nbsp;&nbsp;${postVO.membersVO.name}
                                    </a>
                                </div>
                                <div class="testimonial_thumb">
                                    <a href="<%=request.getContextPath()%>/detailPost?postId=${postVO.postId}&memberId=${postVO.memberId}&action=selectdetail"><img
                                            src="${postVO.pictureVO.url}" style='border-radius:20px;'></a>
                                </div>
                                <div class="testimonial_content">
                                    <div class="testimonial-rating">
                                        <ul>
                                            <li>
                                                <a href="<%=request.getContextPath()%>/detailPost?postId=${postVO.postId}&action=selectdetail">${postVO.createTime}
                                                    發文</a></li>
                                            <li>
                                                <a href="<%=request.getContextPath()%>/detailPost?postId=${postVO.postId}&action=selectdetail"> ${postVO.likeCount}
                                                    個讚</a></li>
                                        </ul>
                                    </div>
        ...
        <div class='row mt-5' style='height:470px;background-position:center;background-size:cover;'
             data-bgimg='<%=request.getContextPath()%>/assets/img/sign-up-image2.jpg'>
            <div class='col-lg-3'></div>
            <div class='col-lg-4 col-sm-4'>
                <div class='row' style='height:6vh;'></div>
                <a href='<%=request.getContextPath()%>/front/login.jsp'>
                    <img style='filter:hue-rotate(150deg) saturate(5) drop-shadow(0 0 16px #fff);'
                         src='<%=request.getContextPath()%>/assets/img/sign-up-image.png'>
                </a>
            </div>
