                    ...
                    <div class="widgets_container footer_instragam">
                        ...
                        <div class="instagram_container">
                            <div class="instagram_thumb">
                                <a href="#"><img src="<%=request.getContextPath()%>/assets/img/about/instragam1.jpg"
                                                 alt=""></a>
                            ...
                            <div class="instagram_thumb">
                                <a href="#"><img src="<%=request.getContextPath()%>/assets/img/about/instragam2.jpg"
                                                 alt=""></a>
                                <div class="instagram_boxcmt">
                                    <span class="likecount">5</span> <span class="commentcount">1</span>
                                </div>
                            ...
                            <div class="instagram_thumb">
                                <a href="#"><img src="<%=request.getContextPath()%>/assets/img/about/instragam3.jpg"
                                                 alt=""></a>
                                <div class="instagram_boxcmt">
                                    <span class="likecount">5</span> <span class="commentcount">1</span>
                                </div>
                            ...
                            <div class="instagram_thumb">
                                <a href="#"><img src="<%=request.getContextPath()%>/assets/img/about/instragam4.jpg"
                                                 alt=""></a>
                                <div class="instagram_boxcmt">
                                    <span class="likecount">5</span> <span class="commentcount">1</span>
                                </div>
                            ...
                            <div class="instagram_thumb">
                                <a href="#"><img src="<%=request.getContextPath()%>/assets/img/about/instragam5.jpg"
                                                 alt=""></a>
                                <div class="instagram_boxcmt">
                                    <span class="likecount">5</span> <span class="commentcount">1</span>
                                </div>
