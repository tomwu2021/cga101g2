            ...
            <div class="checkout_form">
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <Form action="<%=request.getContextPath()%>/member/groupOrder.do" Method="Post" id="CHECKOUT">
                            ...
                            <input type="hidden" name="price" value="${productVO.groupPrice1}">
                            <input type="hidden" name="minAmount" value=" ${groupOrderVO.minAmount}">                           
                            ...
                            <div class="order_table table-responsive">
                                <table>
                                    ...
                                    <tbody>
										 ...
										 <tr>
                                            <td> <strong> ${productVO.productName} </strong></td>
                                           <td id="price"><strong>${productVO.groupPrice1}</strong></td>
                                    ...
                                    <tfoot>
                                     <tr>
                                            ...
                                            <td><strong>時間截單(7天後)</strong></td>                                           
                                            </c:if>
                                             <c:if test="${groupOrderVO.endType == 2}">                          
                                            <td><strong>累計超過${groupOrderVO.minAmount}份後截單</strong></td>                                           
                                            </c:if>
                                        </tr>
